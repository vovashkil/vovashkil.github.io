...
mysql --defaults-extra-file=/etc/mysql/configroot.cnf < /var/tmp/BicyclesDbDump-end-admin.sql
...
cd /var/tmp/
tar -xzf django-end-admin.tar.gz -C /home/ubuntu/environment/
